          ...
          <div>
            <div className="coaching-content d-flex align-items-center">
              ...
              <div className="w-75 ps-5">
                ...
                <a href="/contacto" className="btn-info">
          ...
          <div className="coaching-content d-flex align-items-center">
            ...
            <div className="w-75 ps-5">
              ...
              <p>
                ...
                respaldada por mi experiencia en grupos, el enfoque sistémico y
                la terapia Gestalt. Esto crea un vínculo duradero entre
